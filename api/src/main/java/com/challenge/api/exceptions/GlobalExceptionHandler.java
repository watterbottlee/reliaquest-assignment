...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<GlobalErrorResponse> handleEmployeeNotFound(EmployeeNotFoundException ex) {
        ...
        GlobalErrorResponse response =
                new GlobalErrorResponse(false, ex.getMessage(), null, HttpStatus.NOT_FOUND.toString());
    ...
    public ResponseEntity<GlobalErrorResponse> handleInvalidRequest(InvalidRequestException ex) {
        ...
        GlobalErrorResponse response =
                new GlobalErrorResponse(false, ex.getMessage(), null, HttpStatus.BAD_REQUEST.toString());
